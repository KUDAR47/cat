...
async def keyboard(message: types.Message):
    if message.text=="Year(3)":
        ...
        d1=open("C:/Users\KUDAR/PycharmProjects/pythonProject3/Assets/lecture#1.pdf","rb")
        await bot.send_document(message.chat.id,document=d1)
        d2 = open("C:/Users\KUDAR/PycharmProjects/pythonProject3/Assets/lecture#2.pdf","rb")
        await bot.send_document(message.chat.id, document=d2)
        d3=open("C:/Users\KUDAR/PycharmProjects/pythonProject3/Assets/lecture#3.pdf","rb")
        await bot.send_document(message.chat.id,document=d3)
        d4=open("C:/Users\KUDAR/PycharmProjects/pythonProject3/Assets/lecture#4.pdf","rb")
        await bot.send_document(message.chat.id, document=d4)
        d5=open("C:/Users\KUDAR/PycharmProjects/pythonProject3/Assets/lecture#5.pdf","rb")
        await bot.send_document(message.chat.id, document=d5)
        d6=open("C:/Users\KUDAR/PycharmProjects/pythonProject3/Assets/lecture#6.pdf","rb")
        await bot.send_document(message.chat.id, document=d6)
        d7=open("C:/Users\KUDAR/PycharmProjects/pythonProject3/Assets/lecture#7.pdf","rb")
        await bot.send_document(message.chat.id, document=d7)
        d8=open("C:/Users\KUDAR/PycharmProjects/pythonProject3/Assets/lecture#8.pdf","rb")
        await bot.send_document(message.chat.id, document=d8)
        d9=open("C:/Users\KUDAR/PycharmProjects/pythonProject3/Assets/lecture#8.pdf","rb")
        await bot.send_document(message.chat.id, document=d9)
        d10=open("C:/Users/KUDAR/PycharmProjects/pythonProject3/Assets/lecture#10.pdf","rb")
        await bot.send_document(message.chat.id,document=d10)
        d11=open("C:/Users/KUDAR/PycharmProjects/pythonProject3/Assets/lecture#11.pdf","rb")
        await bot.send_document(message.chat.id, document=d11)
        d12=open("C:/Users/KUDAR/PycharmProjects/pythonProject3/Assets/lecture#12.pdf","rb")
        await bot.send_document(message.chat.id, document=d12)
        d13=open("C:/Users/KUDAR/PycharmProjects/pythonProject3/Assets/lecture#13.pdf","rb")
        await bot.send_document(message.chat.id, document=d13)
        d14=open("C:/Users/KUDAR/PycharmProjects/pythonProject3/Assets/lecture#14.pdf","rb")
        await bot.send_document(message.chat.id,document=d14)
    elif message.text=="theory of mechine":
        await message.reply("please wait its sending")
        d1=open("C:/Users\KUDAR/PycharmProjects/pythonProject3/Assets/machines and mechanisms.pdf","rb")
        await bot.send_document(message.chat.id,document=d1)
